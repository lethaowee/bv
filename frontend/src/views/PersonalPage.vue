            ...
            <div class="card-body">
              <div class="account-settings">
                ...
                <div class="about">
                  <h5>Giới thiệu</h5>
                  <p>
                    Tôi là {{ currentUser.hoTen }}, đang giữ vai trò
                    {{ currentUser.chucVu }} ở phòng ban {{ currentPb }}
                  </p>
                </div>
              </div>
            </div>
                ...
                <div class="row gutters">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                      ...
                      <input
                        v-model="currentUser.maNhanVien"
                        type="text"
                        class="form-control"
                        id="manv"
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                      ...
                      <select
                        id="pb"
                        v-model="currentUser.idPhongBan"
                        class="form-select"
